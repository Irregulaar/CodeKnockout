function Layout() {
  return (
    <section className="w-full h-full flex flex-col items-center text-white">
      ...
      <img className="bg-[#121212] w-full h-full fixed opacity-30 -z-9" src="/layout.png"></img>
      <div className="mb-5">
        <h1
          className="text-4xl font-semibold bg-clip-text bg-gradient-to-b from-[#ff58a6] to-[#ffd23d] w-fit h-fit text-transparent mt-20 line-clamp-3
            balance text-center"
        >
      ...
      <button
        className="cursor-pointer transition-all bg-gradient-to-b from-[#ff58a6] to-[#ffd23d] tracking-wider p-1 rounded duration-300 text-[#251b06]
